# This version added z as the 4th feature, also repeat and padding the sequence
...
out_dir = '//lyta/tomodev/DeepLearning/Playground_stage3/output_groupProc/lstm_based_model/score_txt/v3/'
